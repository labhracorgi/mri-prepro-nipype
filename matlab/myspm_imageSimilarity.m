function myspm_imageSimilarity(imgA,imgB,metric,out_path)
...
%Print modalities:
new_txt = '/similar_measure.txt';
complete_path = strcat(out_path,new_txt);
this_file_ID = fopen(complete_path,'w');

fprintf(this_file_ID,'%d\n',si);
